...
#ifdef USE_RMI_NAME_STRING
const PNTCHAR* Proxy::RmiName_ReplyLogon =_PNT("ReplyLogon");
#else
const PNTCHAR* Proxy::RmiName_ReplyLogon =_PNT("");
#endif
const PNTCHAR* Proxy::RmiName_First = RmiName_ReplyLogon;
