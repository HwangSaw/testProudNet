...
#include "Social_stub.h"


const unsigned char sz_Social_stub_hRmi[] = 
...
namespace SocialC2S {
	...
	bool Stub::ProcessReceivedMessage(::Proud::CReceivedMessage &pa, void* hostTag) 
	{
#ifndef __FreeBSD__ 
		{
			...
			unsigned char x = sz_Social_stub_hRmi[0]; 
			x++; 
		}
#endif
...
__fail:
	...
	#ifdef USE_RMI_NAME_STRING
	const PNTCHAR* Stub::RmiName_ReplyLogon =_PNT("ReplyLogon");
	#else
	const PNTCHAR* Stub::RmiName_ReplyLogon =_PNT("");
	#endif
	const PNTCHAR* Stub::RmiName_First = RmiName_ReplyLogon;
